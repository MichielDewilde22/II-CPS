...
array_size = size(mic_coordinates, 1);
...
samp_rate_beam = info.SampleRate; % normally 50kHz
audio.n_samples = info.TotalSamples; 
audio.duration = audio.n_samples/samp_rate_beam;
...
angles = [azimuths(indicesHalfShere); elevations(indicesHalfShere)];
...
freq_min = 20000;
freq_max = 22000;
freqs_fft = linspace(0, samp_rate_beam, n_fft_bins);
